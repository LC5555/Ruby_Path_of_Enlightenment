...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    original_string = "Hello, "
    hi = original_string  #ambas apontam para o mesmo objeto em memória
    there = "World"
    hi << there
    ...
    # plus equals operator (+=) when building up strings.  Why? #poupar memória
  end
  ...
  def test_strings_can_be_split_with_different_patterns
    ...
    # enlightened about them soon. #POG
  end
